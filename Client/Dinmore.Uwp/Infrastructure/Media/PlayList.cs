...
namespace Dinmore.Uwp.Infrastructure.Media
{
    public static class PlayList
    {
        public static List<PlayListItem> List
        {
            ...
            {
                new PlayListItem( PlayListGroup.Demographic12to17, 1, "Assets/Voice/1-55-64.wav"),
                new PlayListItem( PlayListGroup.Demographic12to17, 2, "Assets/Voice/2-55-64.wav"),
                new PlayListItem( PlayListGroup.Demographic12to17, 3, "Assets/Voice/3-55-64.wav"),
                new PlayListItem( PlayListGroup.Demographic12to17, 4, "Assets/Voice/4-55-64.wav"),
